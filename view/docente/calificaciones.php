                ...
                <div class="card-body">
                    <div class="row card-materias mt-3">
                        ...
                        <div class="col-md-4 text-center">
                            <button class="btn btn-blue btn-block"  data-toggle="modal" data-target="#subirArchivosModal">Subir Archivo</button>
                                            ...
                                            <div id="accordion">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="heading<?=$cont?>">
                                                        <h5 class="mb-0">
                                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapse<?=$cont?>" aria-expanded="true" aria-controls="collapse<?=$cont?>" onclick="mostrarDatos('evaluacion','<?=$dt['unidades']?><?=$dt['nombreMateria']?>',<?=$cont?>)">
                                                                <?=$dt['nombreMateria']?>
                                                            </button>
                                                        </h5>
                                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmArchivo">
                    <div class="col-md-12">
                        <input type="text" value="evaluacion" name="evaluacion" id="evaluacion" hidden>
...
<script src="<?=SERVIDOR?>controller/funciones_agregar_calificacion.js"></script>
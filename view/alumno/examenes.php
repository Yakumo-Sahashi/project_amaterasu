                                            ...
                                            <div id="accordion">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="heading<?=$cont?>">
                                                        <h5 class="mb-0">
                                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapse<?=$cont?>" aria-expanded="true" aria-controls="collapse<?=$cont?>" onclick="mostrarDatos('examen','<?=$dt['unidades']?><?=$dt['nombreMateria']?>',<?=$cont?>,'<?=$dt['idDocentes']?>')">
                                                                <?=$dt['nombreMateria']?>
                                                            </button>
                                                        </h5>
                                                    </div>

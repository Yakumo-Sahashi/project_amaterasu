<!-- Modal Añadir-->
<div class="modal fade" id="anadirMateriaModal" tabindex="-1" aria-labelledby="anadirMateriaModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100 text-center border-bottom border-dark pb-2" id="anadirMateriaModalLabel">
                    <b>Asignar Horario</b></h5>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="miercolesInicio" id="miercolesInicio"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="miercolesFin" id="miercolesFin" class="form-control my-4"
                                                disabled>
                                            ...
                                            <select name="viernesFin" id="viernesFin" class="form-control my-4"
                                                disabled>
...
<script src="<?= SERVIDOR ?>controller/funciones_agregar_horario.js"></script>